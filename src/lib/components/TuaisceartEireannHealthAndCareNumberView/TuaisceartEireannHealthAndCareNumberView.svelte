<script lang="ts">
    ...
    //
    // A headless display for a Tuaisceart Eireann Health and Care (H&C) Number.
...
<!-- TuaisceartEireannHealthAndCareNumberView.svelte -->
<span
    class={`tuaisceart-eireann-health-and-care-number-view ${className}`}
    aria-label={label}
