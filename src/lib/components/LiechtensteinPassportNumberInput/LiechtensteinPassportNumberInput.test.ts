...
import Subject from "./LiechtensteinPassportNumberInput.svelte";
...
describe("LiechtensteinPassportNumberInput", () => {
    ...
    test("can be set to required", () => {
        render(Subject, { props: { label: "Liechtenstein Passport Number", required: true } });
    ...
    test("can be set to disabled", () => {
        render(Subject, { props: { label: "Liechtenstein Passport Number", disabled: true } });
    ...
    test("passes through additional HTML attributes", () => {
        render(Subject, { props: { label: "Liechtenstein Passport Number", "data-testid": "subject" } });
