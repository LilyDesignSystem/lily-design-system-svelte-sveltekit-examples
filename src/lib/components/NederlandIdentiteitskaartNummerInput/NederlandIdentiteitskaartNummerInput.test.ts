...
import Subject from "./NederlandIdentiteitskaartNummerInput.svelte";
...
describe("NederlandIdentiteitskaartNummerInput", () => {
    ...
    test("can be set to required", () => {
        render(Subject, { props: { label: "Dutch National Identity Card Number", required: true } });
    ...
    test("can be set to disabled", () => {
        render(Subject, { props: { label: "Dutch National Identity Card Number", disabled: true } });
    ...
    test("passes through additional HTML attributes", () => {
        render(Subject, { props: { label: "Dutch National Identity Card Number", "data-testid": "subject" } });
