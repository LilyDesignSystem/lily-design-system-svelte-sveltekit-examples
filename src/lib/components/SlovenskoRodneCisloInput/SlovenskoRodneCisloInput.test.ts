...
import Subject from "./SlovenskoRodneCisloInput.svelte";
...
describe("SlovenskoRodneCisloInput", () => {
    ...
    test("can be set to required", () => {
        render(Subject, { props: { label: "Slovak Personal Number", required: true } });
    ...
    test("can be set to disabled", () => {
        render(Subject, { props: { label: "Slovak Personal Number", disabled: true } });
    ...
    test("passes through additional HTML attributes", () => {
        render(Subject, { props: { label: "Slovak Personal Number", "data-testid": "subject" } });
