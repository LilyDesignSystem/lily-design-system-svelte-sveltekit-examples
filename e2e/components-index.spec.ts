...
import { suffixPatternOf } from '../src/lib/data/suffix-pattern';
...
// itself reads (src/lib/data/{components,suffix-pattern}.ts), so a
// future catalog change can't silently drift this test out of sync
// with reality the way a hardcoded number would.
