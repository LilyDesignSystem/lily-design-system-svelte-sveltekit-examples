...
This repository is the Svelte 5 example application: a fully styled reference app demonstrating every catalog component.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-svelte-sveltekit-examples.git
